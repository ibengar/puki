	...
	try {
		...
		global.fakeig = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            mediaUrl: "https://Instagram.com/achmdrizky148",
            mediaType: "VIDEO",
            description: "https://Instagram.com/achmdrizky148", 
            title: 'iBengggggggggggg',
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
    }
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"by : ibeng","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "ibeng","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
